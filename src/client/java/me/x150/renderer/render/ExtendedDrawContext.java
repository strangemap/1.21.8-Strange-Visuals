		...
		SimpleGuiElementRenderState state = new SimpleGuiRenderState(
				...
				(bruh) -> {
...

					{
						// Vertices: 0-1-2-3
						//@formatter:off
						ellipse.vertex(matrices, x, y + height, 0).texture(0, 0).color(r, g, b, a);
						ellipse.vertex(matrices, x + width, y + height, 0).texture(1, 0).color(r, g, b, a);
						ellipse.vertex(matrices, x + width, y, 0).texture(1, 1).color(r, g, b, a);
						ellipse.vertex(matrices, x, y, 0).texture(0, 1).color(r, g, b, a);
						//@formatter:on
					}
				}
		);
