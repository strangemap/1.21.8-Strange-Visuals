...
public class RenderUtils {
	...
	public static Vec3d translateVec3dWithMatrixStack(@NotNull MatrixStack stack, @NotNull Vec3d in) {
	 ...
	 */
	public static NativeImageBackedTexture registerBufferedImageTexture(@NotNull Identifier i, @NotNull BufferedImage bi) {
