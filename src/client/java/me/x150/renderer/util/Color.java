 ...
 */
public record Color(@Range(from=0, to=1) float red, @Range(from=0, to=1) float green, @Range(from=0, to=1) float blue, @Range(from=0, to=1) float alpha) {
	/**
	...
	public Color withRed(@Range(from=0, to=1) float red) {
		return new Color(red, this.green, this.blue, this.alpha);
	}

	public Color withGreen(@Range(from=0, to=1) float green) {
		return new Color(this.red, green, this.blue, this.alpha);
	}

	public Color withBlue(@Range(from=0, to=1) float blue) {
		return new Color(this.red, this.green, blue, this.alpha);
	}

	public Color withAlpha(@Range(from=0, to=1) float alpha) {
